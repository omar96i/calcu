    ...
    @if ($page == 'bonus-b')
        <x-filament::section>
            ...
            <div class="gap-4">
                ...
                <div>
                    <label for="">Fecha base</label>
                    <x-filament::input.wrapper>
                        <x-filament::input type="date" wire:model.live="baseDate" wire:change="closeTableAction()" />
                    </x-filament::input.wrapper>
                </div>
                <div>
                    <label for="">Fecha Fco</label>
                    <x-filament::input.wrapper>
                        <x-filament::input type="date" wire:model.live="Fco" wire:change="closeTableAction()" />
                    </x-filament::input.wrapper>
                </div>
                <div>
                    <label for="">Fecha Fcal</label>
                    <x-filament::input.wrapper>
                        <x-filament::input type="date" wire:model.live="Fcal" wire:change="closeTableAction()" />
                    </x-filament::input.wrapper>
                </div>
            </div>
            <!-- Botones de acción -->
