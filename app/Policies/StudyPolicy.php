...
class StudyPolicy
{
    ...
    {
        return $user->can('delete_any_study');
    }
    ...
    {
        return $user->can('force_delete_study');
    }
    ...
    {
        return $user->can('force_delete_any_study');
    }
    ...
    {
        return $user->can('restore_any_study');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Study $study): bool
    {
        return $user->can('replicate_study');
    }
