<x-filament-panels::page>
        ...
        <x-filament::section>
            ...
            <x-filament::section>
                ...
                <div class="gap-4">
                    ...
                    <div>
                        <label for="">Fecha calculo</label>
                        <x-filament::input.wrapper>
                            <x-filament::input type="date" wire:model="fecha_calculo" />
                        </x-filament::input.wrapper>
                    </div>
                </div>
                <!-- Botones de acción -->
            ...
            @if ($closeTable)
                <livewire:five-year-calculation :year="$year_calculation" :date="$fecha_calculo" :user_id="$selectedCompany" />
            @endif
    ...
    @if ($page == 'quinquenio')
        ...
        <x-filament::section>
            ...
            @if ($closeTable)
                <livewire:five-year-calculation-table2 :year="$year_calculation" :date="$fecha_calculo" :user_id="$selectedCompany" />
            @endif
